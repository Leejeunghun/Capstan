  ...
  <div class="collapse navbar-collapse" id="navbarColor01">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="./search.php">아이디 및 비번 찾기<span class="sr-only">(current)</span></a>
      </li>
   ...
   <a href="https://github.com/Leejeunghun/Capstan"><img src="./img/git.jpg" alt="GIT"></a>
   <a href="http://www.inu.ac.kr/user/indexMain.do?siteId=ese"><img src="./img/ese.png" alt="ese"></a>
</body>
</html>
